package com.example.secureauthservice.module.user.service;

import com.example.secureauthservice.module.auth.dto.LoginRequest;      // Kiểm tra login
import com.example.secureauthservice.module.auth.dto.RegisterRequest;   // Kiểm tra đăng nhập
import com.example.secureauthservice.module.user.dto.UpdateProfileRequest;
import com.example.secureauthservice.module.user.entity.Role;
...
import com.example.secureauthservice.module.user.repository.RoleRepository;
import com.example.secureauthservice.common.exception.UserAlreadyExistsException;
